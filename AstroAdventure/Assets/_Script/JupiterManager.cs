...
public class JupiterManager : MonoBehaviour
{
    ...
    public float taillePlanete = 104.8f;
    // Permet de définir l'ellipse de la planète
    public float longueurEllipse = 1278f;
    public float largeurEllipse = 1238f;
    public float hauteurEllipse = 0f;
    // Permet de définir la rotation de la planète
    public float rotationx = 0.3f;
    public float rotationy = -8f;
    public float rotationz = 0f;
    // Permet de définir la vitesse de la planète
    public float vitesse = 0.135f;
    ...
    void Start()
    {
        ...
        centreEarth = GameObject.Find("Jupiter");
