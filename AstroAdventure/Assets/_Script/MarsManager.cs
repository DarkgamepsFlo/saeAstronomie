...
public class MarsManager : MonoBehaviour
{
    ...
    public float taillePlanete = 55.65f;
    // Permet de définir l'ellipse de la planète
    public float longueurEllipse = 987f;
    public float largeurEllipse = 927f;
    public float hauteurEllipse = 0f;
    // Permet de définir la rotation de la planète
    public float rotationx = 2.5f;
    public float rotationy = -9.5f;
    ...
    void Start()
    {
        ...
        centreEarth = GameObject.Find("Mars");
